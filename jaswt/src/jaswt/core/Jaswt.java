...
public class Jaswt {
	...
	/**
	 * method to lunch a message box error
	 * @param parent shell
	 * @param exception to be view
	 */
	public void lunchMBError(Shell parent, Exception exception) {
		lunchMB(parent, SWT.OK, "FAIL!!!", "Error!!! Messagge: " + exception.getMessage());
	}

	/* metodo che lancia messaggio di errore e scrive log */
	/**
	 * method that lunch message box error and write a log
	 * @param parent shell
	...
	public void lunchMBError(Shell parent, Exception exception, JoggerError joggerError) {
		...
		try {
			...
			lunchMB(parent, SWT.OK, "FAIL!!!", "Error!!! Error while writing the log file.\nError message: " + e.getMessage());
		}
	}

	/* metodo che lancia finestra per selezionare una cartella */
	/**
	 * method that lunch window to select a folder
	 * @param shell parent
	...
	/**
	 * method that lunch window to select file
	 * @param shell parent
	 * @param pathStart to open in the window
